# rl_tune_RL2-1.py
# Optuna hyperparameter search for v5 reward (wait_all + noise training).
# Canonical final tuner; writes best config to rl_tune_RL2-1_best.json.
#
# python rl_tune_RL2-1.py --trials 30 --jobs 4
