# patch_study.py
# Post-hoc Optuna score recalculation using corrected objective
# (mean_wait_all with MAX_WAIT=120, no explicit rejection penalty).
# Run once after tuning if objective formula was updated.
#
# python patch_study.py --study rl_tune_v6.db
